...
<body>
    ...
    <section id="packages" class="secPad">
        <div class="container">
          ...
          <div class="privacy">
            <div class="container">
              <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Available Flights</h3>
              @livewire('flight-booking')
            </div>
